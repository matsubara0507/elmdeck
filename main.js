...
var _matsubara0507$elmdeck$Utils$split = F2(
	function (p, xs) {
		var _p0 = A2(_elm_community$list_extra$List_Extra$dropWhile, p, xs);
		if (_p0.ctor === '[]') {
			return {ctor: '[]'};
		} else {
			var _p1 = A2(_elm_community$list_extra$List_Extra$break, p, _p0);
			var x = _p1._0;
			var zs = _p1._1;
			return {
				ctor: '::',
				_0: x,
				_1: A2(_matsubara0507$elmdeck$Utils$split, p, zs)
			};
		}
	});

var _matsubara0507$elmdeck$Main$readmeMD = '';
var _matsubara0507$elmdeck$Main$slideSize = function (window) {
	var width_ = _elm_lang$core$Basics$round(
		0.45 * _elm_lang$core$Basics$toFloat(window.width));
	var height_ = ((width_ / 4) | 0) * 3;
	return _elm_lang$html$Html_Attributes$style(
		{
			...
			_0: {
				...
				_1: A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(width_),
					'px')
			},
			_1: {
				ctor: '::',
				_0: {
					...
					_1: A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(height_),
						'px')
				},
				_1: {ctor: '[]'}
			}
...
var _matsubara0507$elmdeck$Main$textareaStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
...
var _matsubara0507$elmdeck$Main$halfStyle = function (window) {
	var height_ = _elm_lang$core$Basics$round(
		0.8 * _elm_lang$core$Basics$toFloat(window.height));
	return _elm_lang$html$Html_Attributes$style(
		{
			ctor: '::',
...
var _matsubara0507$elmdeck$Main$displayFlex = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'display', _1: 'flex'},
		_1: {ctor: '[]'}
	});
var _matsubara0507$elmdeck$Main$formatToCLink = function (_p0) {
	return A4(
		_elm_lang$core$Regex$replace,
		_elm_lang$core$Regex$All,
		_elm_lang$core$Regex$regex('\\s+'),
...
var _matsubara0507$elmdeck$Main$customHtmlBlock = function (block) {
	var _p1 = block;
	if (_p1.ctor === 'Heading') {
		var _p3 = _p1._2;
		var hElement = function () {
			...
			_0: A2(
				hElement,
				{
					...
					_0: _elm_lang$html$Html_Attributes$id(
						_matsubara0507$elmdeck$Main$formatToCLink(
							_pablohirafuji$elm_markdown$Markdown_Inline$extractText(_p3))),
					_1: {ctor: '[]'}
				},
				A2(_elm_lang$core$List$map, _pablohirafuji$elm_markdown$Markdown_Inline$toHtml, _p3)),
			_1: {ctor: '[]'}
		};
	} else {
		return A3(
			_pablohirafuji$elm_markdown$Markdown_Block$defaultHtml,
			_elm_lang$core$Maybe$Just(_matsubara0507$elmdeck$Main$customHtmlBlock),
			_elm_lang$core$Maybe$Nothing,
			block);
	}
};
var _matsubara0507$elmdeck$Main$slideView = F2(
	function (window, slide) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: _matsubara0507$elmdeck$Main$slideSize(window),
					_1: {ctor: '[]'}
				}
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('slideContents'),
						_1: {ctor: '[]'}
					},
					slide),
				_1: {ctor: '[]'}
...
var _matsubara0507$elmdeck$Main$markdownView = function (_p4) {
	var _p5 = _p4;
	var blocks = A2(_pablohirafuji$elm_markdown$Markdown_Block$parse, _elm_lang$core$Maybe$Nothing, _p5.textarea);
	var blocksView = A2(
		_elm_lang$core$List$map,
		_elm_lang$core$List$concatMap(_matsubara0507$elmdeck$Main$customHtmlBlock),
		A2(
			_matsubara0507$elmdeck$Utils$split,
			F2(
				function (x, y) {
					return _elm_lang$core$Native_Utils.eq(x, y);
				})(_pablohirafuji$elm_markdown$Markdown_Block$ThematicBreak),
			blocks));
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		A2(
			_elm_lang$core$List$map,
			_matsubara0507$elmdeck$Main$slideView(_p5.window),
			blocksView));
};
var _matsubara0507$elmdeck$Main$update = F2(
	function (msg, model) {
		var _p6 = msg;
		if (_p6.ctor === 'TextAreaInput') {
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
...
var _matsubara0507$elmdeck$Main$model = {
	textarea: '',
	window: {width: 0, height: 0}
};
var _matsubara0507$elmdeck$Main$Model = F2(
	function (a, b) {
		return {textarea: a, window: b};
	});
var _matsubara0507$elmdeck$Main$SizeUpdated = function (a) {
	return {ctor: 'SizeUpdated', _0: a};
};
var _matsubara0507$elmdeck$Main$init = function (model) {
	return {
		ctor: '_Tuple2',
		_0: model,
		_1: A2(_elm_lang$core$Task$perform, _matsubara0507$elmdeck$Main$SizeUpdated, _elm_lang$window$Window$size)
	};
};
var _matsubara0507$elmdeck$Main$TextAreaInput = function (a) {
	return {ctor: 'TextAreaInput', _0: a};
};
var _matsubara0507$elmdeck$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _matsubara0507$elmdeck$Main$displayFlex,
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _matsubara0507$elmdeck$Main$halfStyle(model.window),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_matsubara0507$elmdeck$Main$TextAreaInput),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$defaultValue(model.textarea),
										_1: {
											ctor: '::',
											_0: _matsubara0507$elmdeck$Main$textareaStyle,
											_1: {ctor: '[]'}
										}
									}
								},
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _matsubara0507$elmdeck$Main$markdownView(model),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _matsubara0507$elmdeck$Main$main = _elm_lang$html$Html$program(
	{
		init: _matsubara0507$elmdeck$Main$init(_matsubara0507$elmdeck$Main$model),
		view: _matsubara0507$elmdeck$Main$view,
		update: _matsubara0507$elmdeck$Main$update,
		subscriptions: function (_p7) {
			return _elm_lang$window$Window$resizes(_matsubara0507$elmdeck$Main$SizeUpdated);
		}
	})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _matsubara0507$elmdeck$Main$main !== 'undefined') {
    _matsubara0507$elmdeck$Main$main(Elm['Main'], 'Main', undefined);
}
